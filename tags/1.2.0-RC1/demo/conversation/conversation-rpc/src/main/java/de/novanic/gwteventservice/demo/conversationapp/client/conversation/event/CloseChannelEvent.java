 ...
 *         <br>Time: 00:11:16
 */
public class CloseChannelEvent extends ConversationEvent
{
    public CloseChannelEvent() {}

    public CloseChannelEvent(String anActor, Channel aChannel) {
        super(anActor, aChannel);
    }

    public String toString() {
        return "Channel \"" + getChannel() + "\" closed by user \"" + getActor() + '\"';
    }
}