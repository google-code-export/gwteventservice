 ...
 *         <br>Time: 00:18:52
 */
public class UserJoinEvent extends ConversationEvent
{
    public UserJoinEvent() {}

    public UserJoinEvent(String anActor, Channel aChannel) {
        super(anActor, aChannel);
    }

    public String toString() {
        return "User \"" + getActor() + "\" joined to channel \"" + getChannel() + '\"';
    }
}