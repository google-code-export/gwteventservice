 ...
 */
package de.novanic.eventservice.service.connection.strategy;
...
/**
 * A {@link de.novanic.eventservice.service.connection.strategy.ConnectionStrategy} defines the communication between the
 * client and the server side. That can be used to implement various methods to transfer {@link de.novanic.eventservice.client.event.Event} instances
...
public interface ConnectionStrategy
{
     ...
     */
    ServerEventListener getServerConnector();
     ...
     * @return
     */
    RemoteEventConnector getClientConnector();
}